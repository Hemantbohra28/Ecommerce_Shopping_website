...
<h3>Shopper Stop!</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> For in our free time, when we are free to choose, there is nothing that prevents us from doing so. </p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 1188000000<br>(+91) 118800000000</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@shopperstop.com</a></span>
                </div>
            </li>
